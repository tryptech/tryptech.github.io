...
{% include post-components/gallery.html
	columns = 3
	full_width = true
	images = "/images/projects/doit/gallery/4.png,/images/projects/doit/gallery/3.png,/images/projects/doit/gallery/1.jpg,/images/projects/doit/gallery/2.jpg,
	"
%}

This was the largest organization I had worked for, much more so than PUSO. I learned how to communicate with a multi-level organization to understand and address the indivdual communication needs of different groups, how to work within brand guidelines to produce appealing imagery, and how to capture the attention of a diverse student body.